...
function TrackOrders() {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case "SHIPPED":
        return <span className="request-status" style={{ background: "rgba(14, 165, 233, 0.1)", color: "#0ea5e9", border: "1px solid rgba(14,165,233,0.3)", boxShadow: "0 0 10px rgba(14, 165, 233, 0.2)" }}>🚚 Shipped</span>;
      case "OUT_FOR_DELIVERY":
        return <span className="request-status" style={{ background: "rgba(245, 158, 11, 0.1)", color: "#f59e0b", border: "1px solid rgba(245,158,11,0.3)", boxShadow: "0 0 10px rgba(245, 158, 11, 0.2)" }}>🚚 Out for Delivery</span>;
      case "RECEIVED":
      case "DELIVERED":
      ...
      <main className="dashboard-main">
        ...
        <section className="dashboard-content">
          ...
          <div className="stats-grid" style={{ gridTemplateColumns: "repeat(4, minmax(0, 1fr))" }}>
            ...
            <div className="stat-card" style={{ background: "var(--sp-card-bg)", border: "1px solid rgba(255,255,255,0.05)", cursor: "pointer" }} onClick={() => { setFilter("SHIPPED"); setCurrentPage(1); }}>
              <div className="stat-top">
                <div className="stat-icon" style={{ background: "rgba(14, 165, 233, 0.1)", color: "#0ea5e9", border: "1px solid rgba(14,165,233,0.3)", boxShadow: "0 0 10px rgba(14, 165, 233, 0.2)" }}><Truck size={22} /></div>
                <div className="stat-info">
          ...
          <div className="dashboard-panel">
            ...
            <div className="panel-toolbar" style={{ flexWrap: "wrap", gap: "12px", justifyContent: "space-between" }}>
              <div style={{ display: "flex", gap: "10px", flex: "1", minWidth: "240px", maxWidth: "420px" }}>
                <div className="search-box" style={{ width: "100%", background: "var(--sp-card-bg)", border: "1px solid rgba(255,255,255,0.05)" }}>
                  <Search size={16} />
                  <input
                    type="text"
                  ...
                  />
                  {search && (
                    <button onClick={() => setSearch("")} style={{ background: "none", border: "none", color: "var(--sp-text-muted)", cursor: "pointer" }}>
                      <X size={14} />
                    </button>
                  )}
                </div>
                ...
                {["ALL", "ORDER_PLACED", "PACKED", "SHIPPED", "OUT_FOR_DELIVERY", "RECEIVED"].map((st) => (
                  <button
                    ...
                    style={{
                      ...
                      background: filter === st ? "rgba(14, 165, 233, 0.1)" : "var(--sp-card-bg)",
                      color: filter === st ? "#0284c7" : "var(--sp-text-muted)",
                      fontSize: "12px",
                  ...
                  {loading ? (
                    <tr>
                      <td colSpan="9" style={{ textAlign: "center", padding: "40px 0" }}>
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px", color: "var(--sp-text-muted)" }}>
                    ...
                    <tr>
                      <td colSpan="9" style={{ textAlign: "center", padding: "48px 0" }}>
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", color: "var(--sp-text-muted)" }}>
                          <Truck size={38} color="#94a3b8" />
                          <strong style={{ fontSize: "16px", color: "var(--sp-text-main)" }}>No Orders Found</strong>
                    ...
                    orders.map((o) => (
                      <tr key={o.orderId || o.id}>
                        ...
                        <td>
                          <strong style={{ color: "var(--sp-text-main)" }}>{o.productName}</strong>
                          {o.category && (
                            <div style={{ fontSize: "11px", color: "var(--sp-text-muted)" }}>{o.category.categoryName || o.category}</div>
                          )}
                        </td>
                        <td>
                          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                            <Building2 size={13} color="var(--sp-text-muted)" />
                            <span style={{ fontWeight: "600", color: "var(--sp-text-sub)" }}>
                        ...
                        <td>
                          <div style={{ display: "flex", gap: "6px" }}>
                            <button
                              ...
                              style={{ background: "rgba(14, 165, 233, 0.1)", color: "#0ea5e9", border: "1px solid rgba(14,165,233,0.3)", boxShadow: "0 0 10px rgba(14, 165, 233, 0.2)", border: "1px solid rgba(255,255,255,0.05)" }}
                            >
                              <Truck size={14} />
                            </button>
                            <button
                              ...
                              style={{ background: "var(--sp-card-surface)", color: "var(--sp-text-sub)", border: "1px solid rgba(255,255,255,0.05)" }}
                            >
                              <Eye size={14} /> View
                            </button>
                          </div>
          ...
          <div className="modal-card" style={{ maxWidth: "620px" }}>
            <div className="modal-header">
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                <div style={{ width: "36px", height: "36px", borderRadius: "10px", background: "rgba(14, 165, 233, 0.1)", color: "#0ea5e9", border: "1px solid rgba(14,165,233,0.3)", boxShadow: "0 0 10px rgba(14, 165, 233, 0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Truck size={20} />
                </div>
                <div>
                  <h2 style={{ fontSize: "17px", fontWeight: "800", color: "var(--sp-text-main)", margin: 0 }}>
                    Track Order • {selectedOrder.orderId}
                  </h2>
                  <p style={{ fontSize: "12px", color: "var(--sp-text-muted)", margin: 0 }}>
            ...
            <div className="modal-body" style={{ display: "flex", flexDirection: "column", gap: "18px", padding: "20px 24px" }}>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: "18px", fontWeight: "800", color: "var(--sp-text-main)", marginTop: "2px" }}>
                    {selectedOrder.status?.replace(/_/g, " ")}
                  </div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <span style={{ fontSize: "11px", fontWeight: "700", color: "var(--sp-text-muted)", textTransform: "uppercase" }}>
                    Expected Delivery
                  </span>
              ...
              <div>
                <h4 style={{ fontSize: "12px", fontWeight: "800", color: "var(--sp-text-muted)", margin: "0 0 14px 0", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                      ...
                      <div key={stage.key} style={{ display: "flex", gap: "14px", position: "relative" }}>
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", minWidth: "28px" }}>
                          <div style={{
                            ...
                            fontWeight: "800",
                            fontSize: "12px",
                            background: state === "completed" ? "#10b981" : state === "current" ? "#0284c7" : "var(--sp-card-surface)",
                          ...
                          {!isLast && (
                            <div style={{
                              ...
                              flex: 1,
                              minHeight: "32px",
                              background: state === "completed" ? "#10b981" : "rgba(255,255,255,0.05)",
                              margin: "3px 0"
                            }} />
                          )}
                        </div>
                        ...
                        <div style={{ paddingBottom: isLast ? "0" : "18px", paddingTop: "2px" }}>
                          <div style={{
                            ...
                            color: state === "current" ? "#0284c7" : state === "completed" ? "var(--sp-text-main)" : "var(--sp-text-muted)"
                          }}>
                            {stage.label}
                          </div>
                          <div style={{ fontSize: "12px", color: "var(--sp-text-muted)", marginTop: "1px" }}>
                            {stage.desc}
                          </div>
                        </div>
                      </div>
          ...
          <div className="modal-card" style={{ maxWidth: "680px" }}>
            <div className="modal-header">
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                <div>
                  <h2 style={{ fontSize: "18px", fontWeight: "800", color: "var(--sp-text-main)", margin: 0 }}>
            ...
            <div className="modal-body" style={{ display: "flex", flexDirection: "column", gap: "16px", padding: "20px 24px" }}>
              {/* Order Info Grid */}
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", background: "var(--sp-card-surface)", padding: "16px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.05)" }}>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Order ID</span>
                  <div style={{ fontSize: "14px", fontWeight: "800", color: "#0284c7" }}>{detailsOrder.orderId}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Request ID</span>
                  <div style={{ fontSize: "14px", fontWeight: "700", color: "var(--sp-text-main)" }}>REQ-{detailsOrder.product?.productId || detailsOrder.productId || "—"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Product Name</span>
                  <div style={{ fontSize: "14px", fontWeight: "700", color: "var(--sp-text-main)" }}>{detailsOrder.productName}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Category</span>
                  <div style={{ fontSize: "14px", fontWeight: "600", color: "var(--sp-text-sub)" }}>{detailsOrder.category?.categoryName || detailsOrder.category || "General"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Requester</span>
                  <div style={{ fontSize: "14px", fontWeight: "700", color: "var(--sp-text-main)" }}>{detailsOrder.user?.username || user?.username || "Employee"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Assigned Supplier</span>
                  <div style={{ fontSize: "14px", fontWeight: "700", color: "var(--sp-text-main)" }}>{detailsOrder.supplier?.supplierName || detailsOrder.supplierName || "Authorized Vendor"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Department</span>
                  <div style={{ fontSize: "14px", fontWeight: "600", color: "var(--sp-text-sub)" }}>{detailsOrder.department?.departmentName || detailsOrder.department || "Enterprise"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "var(--sp-text-muted)", fontWeight: "700", textTransform: "uppercase" }}>Quantity & Unit Price</span>
                  <div style={{ fontSize: "14px", fontWeight: "700", color: "var(--sp-text-main)" }}>{detailsOrder.quantity} units @ ₹{detailsOrder.unitPrice?.toLocaleString() || "—"}</div>
                </div>
              </div>

              {/* Payment & Status Grid */}
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", background: "rgba(56,189,248,0.1)", padding: "16px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.05)" }}>
                <div>
                  <span style={{ fontSize: "11px", color: "#0ea5e9", fontWeight: "700", textTransform: "uppercase" }}>Total Amount</span>
                  <div style={{ fontSize: "18px", fontWeight: "900", color: "#0284c7" }}>₹{detailsOrder.totalAmount?.toLocaleString()}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "#0ea5e9", fontWeight: "700", textTransform: "uppercase" }}>Payment Status</span>
                  <div style={{ fontSize: "14px", fontWeight: "800", color: "#15803d" }}>✓ {detailsOrder.paymentStatus || "COMPLETED"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "#0ea5e9", fontWeight: "700", textTransform: "uppercase" }}>Payment Method</span>
                  <div style={{ fontSize: "13px", fontWeight: "700", color: "var(--sp-text-main)" }}>{detailsOrder.payment?.paymentMethod || "UPI / Treasury"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "#0ea5e9", fontWeight: "700", textTransform: "uppercase" }}>Transaction Reference</span>
                  <div style={{ fontSize: "12px", fontFamily: "monospace", color: "var(--sp-text-sub)" }}>{detailsOrder.transactionId || detailsOrder.payment?.transactionId || "TXN-VERIFIED"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "#0ea5e9", fontWeight: "700", textTransform: "uppercase" }}>Order Date</span>
                  <div style={{ fontSize: "13px", color: "var(--sp-text-sub)" }}>{detailsOrder.orderDate ? new Date(detailsOrder.orderDate).toLocaleString() : "—"}</div>
                </div>
                <div>
                  <span style={{ fontSize: "11px", color: "#0ea5e9", fontWeight: "700", textTransform: "uppercase" }}>Current Order Status</span>
